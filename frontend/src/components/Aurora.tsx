...
export default function Aurora(props: AuroraProps) {
  ...
  useEffect(() => {
    ...
    rendererGl.blendFunc(rendererGl.ONE, rendererGl.ONE_MINUS_SRC_ALPHA);
    rendererGl.canvas.style.backgroundColor = 'transparent';
    ...
    ctn.appendChild(rendererGl.canvas);
    ...
    return () => {
      ...
      if (ctn && rendererGl.canvas.parentNode === ctn) {
        ctn.removeChild(rendererGl.canvas);
      }
